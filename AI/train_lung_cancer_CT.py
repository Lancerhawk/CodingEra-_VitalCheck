...
# Constants for CT scan processing
IMAGE_SIZE = (224, 224)  # Larger input size for CT scans
...
def create_model():
    model = models.Sequential([
        # Enhanced architecture for CT scan analysis
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5001)  # Different port from brain tumor model